import { AnimationFrameQueueScheduler } from './lib/animation-frame-queue-scheduler.js';
import { IdleQueueScheduler } from './lib/idle-queue-scheduler.js';
import { Scheduler } from './lib/scheduler.js';
export { AnimationFrameQueueScheduler } from './lib/animation-frame-queue-scheduler.js';
 ...
 * QueueSchedulers.
 */
export declare const animationQueueScheduler: AnimationFrameQueueScheduler;
/**
 * The global IdleQueueScheduler.
 *
 * Queues should not create their own IdleQueueScheduler.
 */
export declare const idleQueueScheduler: IdleQueueScheduler;
